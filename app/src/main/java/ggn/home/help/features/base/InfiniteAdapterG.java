...
import com.efarmx.app.features.base.LoadingViewHolder;
...
public abstract class InfiniteAdapterG<B extends ViewDataBinding> extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        try {
            if (!(holder instanceof LoadingViewHolder)) {
                ...
                bindData(position, baseViewHolder);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    protected abstract void bindData(int position, BaseViewHolder baseViewHolder);
    ...
    public class BaseViewHolder extends RecyclerView.ViewHolder {
        ...
        public BaseViewHolder(B itemView) {
